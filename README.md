...
- **Flow:** Login → Auth callback → consent check (profiles: `tos_accepted`, `privacy_accepted`) → redirect to `return_to` or **https://plus.streettaco.com.au**.
...
| `/consent` | Accept ToS & Privacy; updates `profiles` with accepted_at and version |
